...
class _PreferenceSwipeScreenState extends State<PreferenceSwipeScreen> {
  ...
  final List<PreferenceSwiperCard> _cards = const [
    PreferenceSwiperCard(
      ...
      category: 'MONUMENT',
      imageUrl: 'https://images.unsplash.com/photo-1555992336-03a23c7b20ee?auto=format&fit=crop&w=600',
      emoji: '🏛️',
    ),
    PreferenceSwiperCard(
      id: '2',
    ...
    PreferenceSwiperCard(
      ...
      title: 'Sidi Bou Said',
      category: 'CULTURE',
      imageUrl: 'https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=600',
      emoji: '🎨',
    ),
    PreferenceSwiperCard(
      id: '6',
      ...
      category: 'CULTURE',
      imageUrl: 'https://images.unsplash.com/photo-1539650116574-8efeb4270b4e?auto=format&fit=crop&w=600',
      emoji: '🕌',
    ),
    PreferenceSwiperCard(
      id: '7',
      ...
      category: 'ADVENTURE',
      imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=600',
      emoji: '🤿',
    ),
    PreferenceSwiperCard(
      id: '8',
      ...
      category: 'MONUMENT',
      imageUrl: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&w=600',
      emoji: '🏺',
    ),
  ];
