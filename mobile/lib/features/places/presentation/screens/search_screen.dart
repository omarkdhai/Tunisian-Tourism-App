...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<Place> _allPlaces = [
    Place(id: '1', name: 'El Djem Amphitheatre', description: 'Stunning Roman Amphitheatre', category: 'MONUMENT', governorate: 'Mahdia', longitude: 10.7069, latitude: 35.2967, averageRating: 4.9, reviewCount: 380, imageUrl: 'https://images.unsplash.com/photo-1555992336-03a23c7b20ee?auto=format&fit=crop&w=400'),
    ...
    Place(id: '3', name: 'Sidi Bou Said', description: 'Iconic blue and white village', category: 'CULTURE', governorate: 'Tunis', longitude: 10.3422, latitude: 36.8703, averageRating: 4.8, reviewCount: 900, imageUrl: 'https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=400'),
    ...
    Place(id: '5', name: 'Medina of Tunis', description: 'Ancient walled city market', category: 'CULTURE', governorate: 'Tunis', longitude: 10.1698, latitude: 36.7976, averageRating: 4.7, reviewCount: 1100, imageUrl: 'https://images.unsplash.com/photo-1539650116574-8efeb4270b4e?auto=format&fit=crop&w=400'),
    ...
    Place(id: '7', name: 'Ksar Ouled Soltane', description: 'Berber fortified granary', category: 'MONUMENT', governorate: 'Tataouine', longitude: 9.7592, latitude: 32.8775, averageRating: 4.8, reviewCount: 210, imageUrl: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&w=400'),
    Place(id: '8', name: 'Tabarka Coral', description: 'Scuba diving paradise', category: 'ADVENTURE', governorate: 'Jendouba', longitude: 8.7558, latitude: 36.9545, averageRating: 4.6, reviewCount: 178, imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=400'),
  ];
